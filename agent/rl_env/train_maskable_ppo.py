...
Installation (dans le venv général à la racine du dépôt):
...
Placer ce fichier dans agent/rl_env/train_maskable_ppo.py, puis depuis agent/:
...
def main(argv: list[str] | None = None) -> None:
    ...
    # Racines : agent/ (rl_env) + backend/ (game_engine, simulation).
    ...
    try:
        ...
        raise SystemExit('Placer le script dans agent/rl_env/ et le lancer depuis agent/.\n' + str(exc)) from exc
